...
def errorplot(dir_name):
 ...
 #       plt.plot(Delta, Error, "rx-", markersize = 10, label = "0.25 Data Hopfield")
        plt.plot(Delta, Errorb, "b-", label = "0.75 Data Hopfield")

#        plt.plot(DeltaN, ErrorN, "bx-", markersize = 10, label = "0.25 Data Notfield")
        plt.plot(DeltaN, ErrorNb, "k-", label = "0.75 Data Notfield")
 ...
 #       plt.plot(Delta, 1/(1+Delta*Delta), "b-", label = "Delta Squared")
        ...
        plt.plot(Delta, Delta**(-.9), "k--", label = "Notfield $\Delta^{-0.9}$")
        plt.plot(Delta, Delta**(-1.4), "b--", label = "Hopfield $\Delta^{-1.4}$")
        
        plt.plot(Delta, Delta**(-2), "m-", label = "Ideal $\Delta^{-2}$")

...
public class Ent {
	public static void main(String[] args) {
		...
		try {
			...
			// outputStream.println("["+A1 + "\t"+B1 + "\t" + C1 + "\t" + A2 +
			// "\t"+B2 + "\t" + C2 + "\t"
			// +pA1 + "\t"+pB1 + "\t" + pC1 + "\t" + pA2 + "\t"+pB2 + "\t" +
			// pC2+ "]");
			// outputStream.println("[∆1\t∆2] ");
			//outputStream.println("k = .01\tA(0) ")
			outputStream.println("∆ = " + Double.toString(delta1));
			outputStream.println();
			outputStream.println("A1B1\tB1A1\tB1C1\tC1B1\tC1A2\tA2B2\tB2A2\tB2C2\tC2B2\tC1A1\tC2A2");
			outputStream.println(A1B1 + "\t" + B1A1 + "\t" + B1C1 + "\t" + C1B1 + "\t" + C1A2 + "\t" + A2B2 + "\t" +
					B2A2 + "\t" + B2C2 + "\t" + C2B2 + "\t" + C1A1 + "\t" + C2A2);
			outputStream.println();
			outputStream.println("A1'B1'\tB1'A1'\tB1'C1'\tC1'B1'\tC1'A2'\tA2'B2'\tB2'A2'\tB2'C2'\tC2'B2'\tC1'A1'\tC2'A2'");
			outputStream.println(pA1B1 + "\t" + pB1A1 + "\t" + pB1C1 + "\t" + pC1B1 + "\t" + pC1A2 + "\t" + pA2B2 + "\t" +
					pB2A2 + "\t" + pB2C2 + "\t" + pC2B2 + "\t" + pC1A1 + "\t" + pC2A2);
			outputStream.println();
			...
			for (t = 0; t <= timeMax; t++) {
				if (t % (timeMax / 1000) == 0) {
					...
					outputStream.print(-1 * (xC1A2 + xpC2A1));
					outputStream.print("\t");
		...
		System.out.println(A1 + "\t" + B1 + "\t" + C1 + "\t" + E1 + "\t" + A2 + "\t" + B2 + "\t" + C2 + "\t" + E2 + "\t"
		...
		System.out.println(xC1A1 + "\t" + xC1A2 + "\t" + xC2A2 + "\t" + xC2A1 + "\t" + xpC1A1 + "\t" + xpC1A2 + "\t"
				+ xpC2A2 + "\t" + xpC2A1);
		// System.out.println("Incorrect / Correct");
		// System.out.println((xC1A2+xpC2A1)/(xC2A1+xpC1A2));
		// if (args[1].equalsIgnoreCase("h")){
		// System.out.println("e^-∆^2=" + Math.exp(-1*delta1*delta1));
		// }
		// else if (args[1].equalsIgnoreCase("n")){
		// System.out.println("e^-∆=" + Math.exp(-1*delta1*delta1));
		// }
		System.out.println("Average ∆I/∆C = " + sum/1000);
